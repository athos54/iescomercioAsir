  ...
  <body>
    ...
    <?php
      if(isset($_SESSION['win'])){
        echo "<h1 style='color:red'>Ha ganado ".$_SESSION['win']."</h1>";
        ?>
        <meta http-equiv="refresh" content="1;URL='sesiones-1-12-2.php?accion=empezar'" /> 
        <?php
      }
    ...
    <form action="sesiones-1-12-2.php" method="get">
      ...
      <table>
        ...
        <tr>
          <td><button type="submit" name="accion" value="b" style="font-size: 40px; line-height: 40px;">B</button><button type="submit" name="accion" value="c" style="font-size: 40px; line-height: 40px;">C</button></td>
          <?php
    ...
    <footer>
      <p class="ultmod">
        ...
        <p class="licencia">
          ...
          <meta http-equiv="refresh" content="0.5;URL='sesiones-1-12-2.php?accion=c'" />
